...
import logo from "../landing page/logo.svg"; // Adjust the path to your logo
...
const DashboardPage = () => {
  ...
  const [data, setData] = useState<DataItem[]>([]); // Specify the type for data
      ...
      <aside className="w-64 bg-gray-700 shadow-md">
        ...
        <nav className="mt-4 bg-black">
          <ul>
            ...
            <Link href='/dashboard/model'><li className="p-4 hover:bg-gray-800 cursor-pointer">Model</li></Link>
